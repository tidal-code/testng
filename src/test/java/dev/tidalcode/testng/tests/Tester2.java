...
@Feature(value = "Functional Tests")
public class Tester2 {

    @Story("Test JIRA ID - Search")
    @JiraId(value = "234343")
    @Test(groups = {"SmokeTest", "RegressionTest", "allure"}, description = "TestInfo to verify search navigation Copy")
    public void testSearchNavigation2() {
        ...
        SearchActions.selectFromSearchResults2(4);
    ...
    @Story("Test JIRA ID - Search")
    @JiraId(value = "234343")
    @Test(groups = {"SmokeTest", "RegressionTest", "allure"}, description = "TestInfo to verify search navigation Copy 3")
    ...
    @Story("Test JIRA ID - Search")
    @JiraId(value = "234343")
    @Test(groups = {"SmokeTest", "RegressionTest", "allure"}, description = "TestInfo to verify search navigation Copy 4")
    public void testSearchNavigation4() {
        TestInfo.given("Searching for product");
        TestInfo.step("Searching for product in the next page");
        HomeActions.searchForItem("Shampoo");
        TestInfo.when("Selecting an item");
