...
public class CustomReporter implements IReporter {
    ...
    public void generateReport(
        ...
        for (Map.Entry<Class<?>, Set<ITestResult>> entry : results.entrySet()) {
            ...
            p1.setProperty(XMLConstants.ATTR_TIMESTAMP, formattedTime());
            ...
            String outputDirectory = defaultOutputDirectory + File.separator + "custom_junitreports";
    ...
    protected String getTestName(ITestResult result) {
        return result.getAttribute("customNameAttribute").toString();
    }
